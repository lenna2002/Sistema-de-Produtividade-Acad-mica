...
public class Sistema {
	...
	public void addProjetos() {
		...
		System.out.println("Mês e ano do início do projeto:");
		mesInicio = input.nextInt();
		anoInicio = input.nextInt();
		
		System.out.println("Mês e ano do término do projeto:");
		mesTermino = input.nextInt();
		anoTermino = input.nextInt();
	...
	public void addPublicacao() {
		...
		for(Projetos c: projetos) {
			if(c.getMatricula() == matricula) {
				...
				System.out.println("Mês e ano da publicação:");
				mesDePublicacao = input.nextInt();
